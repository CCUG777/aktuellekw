        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <nav aria-label="Informations-Links" className="flex flex-col gap-2">
              ...
              <Link href="/tagerechner" className="text-sm text-text-secondary hover:text-text-primary transition-colors">
                Tagerechner
              </Link>
              ...
              <Link href="/feiertage/2025" className="text-sm text-text-secondary hover:text-text-primary transition-colors">
                Feiertage 2025
              </Link>
              <Link href={`/feiertage/${year}`} className="text-sm text-text-secondary hover:text-text-primary transition-colors">
                Feiertage {year}
              </Link>
              ...
              <Link href="/sommerzeit-2026" className="text-sm text-text-secondary hover:text-text-primary transition-colors">
                Sommerzeit 2026
              </Link>
